...
public class AppOnlineStore {
    ...
    private static void añadirArticulo() {
        ...
        controlador.añadirArticulo(codigo, descripcion, precio, envio, tiempo);
    ...
    private static void añadirCliente() {
        ...
        do {
            ...
            email = sc.nextLine();
            if (email.isEmpty() || controlador.getClientes().containsKey(email))
                System.out.println("Email vacío o ya registrado. Intenta otro.");
        } while (email.isEmpty() || controlador.getClientes().containsKey(email));
        ...
        controlador.añadirCliente(nombre, domicilio, nif, email, tipo.equals("s"));
    ...
    private static void añadirPedido() {
        ...
        try {
            controlador.añadirPedido(email, codigo, cantidad);
